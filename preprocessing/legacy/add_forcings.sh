#!/bin/bash
#SBATCH --job-name=add_forcings    # job name
#SBATCH --ntasks=1            # the job is sequential
#SBATCH --cpus-per-task=24           # number of cores per tasks, see how many GPUs per node and take proportional amount of CPUs
...
srun python legacy/add_forcings.py